...
const Mobileicons = () => {
  ...
  return (
    <div className="flex items-center gap-2 p-2 rounded-full bg-white shadow-[0px_0px_10px_0px_#00000026] md:hidden">
      <a
        href="#"
      ...
      <button
        id="burger-toggle"
        className="relative z-[1100]"     // higher than menu backdrop
        onClick={handleClick}
