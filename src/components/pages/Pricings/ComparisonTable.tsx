...
const ComparisonTable: React.FC<ComparisonTableProps> = ({ categories }) => {
                ...
                {categories.map((category, categoryIndex) => (
                  <React.Fragment key={categoryIndex}>
                    <thead>
                      <tr>
                        <th
                          className={`text-center md:h-[150px] h-[110px] p-2 ${
                            category.name === "People"
                              ...
                              ? "p-[8px] md:p-[16px]"
                              : category.name === "Sales & Orders"
                              ? "p-[7.6px] md:p-[15.6px]"
                              : category.name === "Purchases"
                              ? "p-[7.8px] md:p-[16px]"
                              : category.name === "Inventory Operations"
                              ? "p-[7.6px] md:p-[15.6px]"
                              ...
                              ? "p-[7.9px] md:p-[15.9px]"
                              : category.name === "Accounting & Financial"
                              ? "p-[7.7px] md:p-[15.6px]"
                              : category.name === "Analytics"
                              ? "p-[7.7px] md:p-[15.9px]"
                              : category.name === "General Tools"
                              ? "p-[7.7px] md:p-[15.6px]"
                      ...
                      <div key={categoryIndex}>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {plan.price === 0 ? "Free" : `$${plan.price}`}<span className="text-xs">{plan.price === 0 ? "" : `/month`}</span>
                            </h3>
