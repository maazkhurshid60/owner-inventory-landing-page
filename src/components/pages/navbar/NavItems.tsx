...
<NavDropdown label="Features">
  ...
  >
    {/* Left Section (9/12) */}
    <div className="col-span-12 md:col-span-9 overflow-y-auto pr-4 
...
<NavDropdown label="Industries">
  ...
  >
    {/* Left Section (9/12) */}
    <div  className={`overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-[#D9D9D9] scrollbar-track-transparent
    ${industryDetailsMap[selectedIndustryKey] ? "md:col-span-9 col-span-12" : "col-span-12"}`}>
      <div className="grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6 content-start">
  ...
  >
    {/* Left Section (9/12) */}
    <div  className={`overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-[#D9D9D9] scrollbar-track-transparent
    ${resourcesDetailsMap[selectedResourceKey] ? "md:col-span-9 col-span-12" : "col-span-12"}`}>
      <div className="grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6 content-start">
