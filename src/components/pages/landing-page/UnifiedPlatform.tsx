...
export default function UnifiedPlatform() {
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      ...
      mm.add("(min-width:768px) and (max-width:1023px)", () => {
        gsap.timeline({
          scrollTrigger: {
            trigger: sectionRef.current, // FIX: Add trigger element
            start: "top top",
            end: "+=200%", // Better calculation
            pin: true,
            scrub: 1.2,
            markers: true,
    ...
    }, 300); // Increased timeout for better loading
  ...
  return (
    <div ref={sectionRef} className="pt-4 md:pt-28 lg:pt-[0px]">
