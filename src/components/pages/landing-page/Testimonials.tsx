...
const testimonials = [
  ...
  return (
    <section
      className="relative ownerinventory-landing-reviews mx-auto overflow-y-hidden rounded-[40px] xl:h-[1268px] md:h-[1077px]  xl:py-[100px] md:py-20 py-10 xl:mt-40 md:mt-28 mt-20"
      style={{
        backgroundImage: `
    ...
    >
      <div className="absolute hidden md:block z-10 w-full h-full pointer-events-none bg-gradient-to-b from-[#ffffff00] to-[#ffffff80]"></div>
      <div className=" wrapper">
        ...
        <div className="columns-container columns-1 md:columns-2 lg:columns-3 mx-auto w-full max-w-[342px] md:max-w-full justify-center items-center md:gap-6">
          {testimonials.map((item, i) => (
            <div
              key={i}
              className="testimonial-card relative inline-block md:inline-block bg-white shadow-[0px_0px_20px_0px_rgba(0,0,0,0.05)] rounded-[30px] xl:p-6 p-5 md:mb-6 mb-20 items-center justify-center break-inside-avoid"
            >
              ...
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <p
                    className="font-onest font-medium text-[#795CF5] xl:text-sm text-xs"
