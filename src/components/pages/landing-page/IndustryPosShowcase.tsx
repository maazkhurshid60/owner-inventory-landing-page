...
//         gsap.set(descriptionRefs.current[index], { opacity: 0, x: -20 });
//         gsap.set(imageRefs.current[index], { opacity: 0, x: 20 });
...
//       )
//       // Move cards container to the right
//       .to(
...
//           0
//         )
//         // Reset cards container position
//         .to(
//           cardsContainerRef.current,
//           {
//             x: 0,
...
//             className={`p-2 rounded-full shadow-[0_4px_6px_-4px_rgba(0,0,0,0.1)] border transition-all duration-300 ${isAnimating || isHovering
...
//                 disabled={isAnimating || isHovering}
//                 className={`transition-all duration-300 ease-in-out ${index === currentSlide
...
//             onClick={nextSlide}
//             disabled={isAnimating || isHovering}
//             className={`p-2 rounded-full border shadow-[0_4px_6px_-4px_rgba(0,0,0,0.1)] transition-all duration-300 ${isAnimating || isHovering
//               ? "border-gray-200 text-gray-400 cursor-not-allowed"
//               : "border-gray-300 text-gray-600 hover:bg-gray-50 hover:scale-105 active:scale-95"
//               } ${isAnimating || isHovering ? "opacity-50" : ""}`}
...
//               <div ref={cardsContainerRef} className="flex gap-4 lg:gap-6 items-stretch justify-between relative z-10">
...
//                             }}
//                             className={`col-span-12 md:col-span-5 absolute right-4 bottom-20 w-[40%] h-[60%] ${screenSize === "mobile" || isExpanded
//                               ? "opacity-100 relative right-auto bottom-auto w-full h-auto"
//                               : "opacity-0"
//                               }`}
//                           >
//                             <Image
...
//                             }}
//                             className={`text-[24px] lg:text-[28px] lg:whitespace-nowrap xl:text-[32px] font-medium mb-4 ${screenSize === "mobile" || isExpanded
//                               ? "text-[var(--text-dark)]"
...
//                             }}
//                             className={`text-sm px-56 lg:text-base text-[var(--text-grey)] absolute top-[90px] left-4 w-full pl-4 ${screenSize === "mobile" || isExpanded
//                               ? "opacity-100 relative top-auto right-auto"
//                               : "opacity-0"
//                               }`}
//                           >
//                             {item.description}
...
//                           overflow-hidden ${screenSize === "mobile" || isExpanded
//                               ? "w-auto max-w-[180px]"
//                               : "w-full max-w-[85%]"
//                             }`}
//                         >
...
//                           Read more
//                           <span
//                             className={`px-4 py-[18px] rounded-[50%] ${item.originalIndex % 2 === 0
//                               ? "bg-[#1AD1B9]"
//                               : "bg-[#795CF5]"
//                               }`}
//                           >
...
//                         }}
//                         className={`hidden md:flex absolute top-14 left-0 ${screenSize === "mobile" || isExpanded
//                           ? "opacity-0"
//                           : "opacity-40"
//                           }`}
//                       >
...
//                           svgRefs.current[i] = el;
//                         }}
//                         className={`hidden md:flex absolute right-0 top-0 ${screenSize === "mobile" || isExpanded
//                           ? "opacity-0"
//                           : "opacity-40"
//                           }`}
//                       >
